...
echo b main > gdbcmd
echo r -n $CAM_NUM -w $CAM_WIDTH -h $CAM_HEIGHT -f $CAM_FPS $VIEW_COODINATE >> gdbcmd
gdb ./picam360-driver.bin -x gdbcmd

else

./picam360-driver.bin -n $CAM_NUM -w $CAM_WIDTH -h $CAM_HEIGHT -f $CAM_FPS $VIEW_COODINATE
